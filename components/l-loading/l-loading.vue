<template>
	<view v-if="show" class="l-loading" :class="mode == 'circle' ? 'l-loading-circle' : 'l-loading-flower'" :style="[cricleStyle]">
	</view>
</template>
...
<style lang="scss" scoped>
	...
	.l-loading-circle {
		...
		animation: l-circle 1s linear infinite;
	}
	...
	.l-loading-flower {
		...
		animation: l-flower 1s steps(12) infinite;
